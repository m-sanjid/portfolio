...
const AboutSection = () => {
  return (
    ...
    >
      ...
      <p>
        I obsess over the little things — from typography and micro-interactions
        to accessibility and UX flow. When I'm not deep in code or pushing
        pixels, I'm sketching ideas, writing, or exploring the city's best
        coffee spots.
      </p>
      <p>
        I'm currently open to full-time roles and available for select freelance
        ...
        >
          ...
          <IconChevronRight className="h-4 w-4 opacity-0 transition-all duration-300 group-hover:translate-x-2 group-hover:opacity-100" />
        </Link>
      </p>
    </MotionDiv>
  );
